class SiteSettingResponse {
  ...
  final num? deliveryChargeFreeAmount;
  ...
  factory SiteSettingResponse.fromJson(Map<String, dynamic> json) =>
      SiteSettingResponse(
        ...
        mediaConfiguration: json["MediaConfiguration"] == null
            ? []
            : List<MediaConfiguration>.from(json["MediaConfiguration"]!
                .map((x) => MediaConfiguration.fromJson(x))),
        applicationPolicy: json["ApplicationPolicy"] == null
            ? null
            : ApplicationPolicy.fromJson(json["ApplicationPolicy"]),
        footerMenus: json["FooterMenus"] == null
            ? []
            : List<FooterMenu>.from(
                json["FooterMenus"]!.map((x) => FooterMenu.fromJson(x))),
        bankDetails: json["BankDetails"] == null
            ? []
            : List<dynamic>.from(json["BankDetails"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "MediaConfiguration": mediaConfiguration == null
            ? []
            : List<dynamic>.from(mediaConfiguration!.map((x) => x.toJson())),
        "ApplicationPolicy": applicationPolicy?.toJson(),
        "FooterMenus": footerMenus == null
            ? []
            : List<dynamic>.from(footerMenus!.map((x) => x.toJson())),
...
class ApplicationPolicy {
  ...
  final num? userPointOnRegistration;
  final num? requiredPointOnPostProduct;
  final num? requiredPointOnPlaceBidding;
...
enum CategoryName { howItsWorks, categories, myAccount, information }

final categoryNameValues = EnumValues({
  "Categories": CategoryName.categories,
  "How its works": CategoryName.howItsWorks,
  ...
  factory MediaConfiguration.fromJson(Map<String, dynamic> json) =>
      MediaConfiguration(
        ...
        extension: json["Extension"] == null
            ? []
            : List<String>.from(json["Extension"]!.map((x) => x)),
      );
