...
import 'package:nilam/core/error/custom_error.dart';
import 'package:nilam/core/error/custom_exception.dart';
...
import 'package:nilam/features/domain/entities/entity_map/entity_map.dart';
...
class RemoteGatewayBase {
  ...
  CustomError error(String body) {
    return CustomError(message: body);
  }
